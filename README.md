...
The Data Specification on Habitats and Biotopes – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Habitats and Biotopes.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Habitats and Biotopes](http://inspire.ec.europa.eu/id/ats/data-hb/3.0/hb-gml) | INSPIRE spatial data set encoded in GML, Habitats and Biotopes features |
| [Application Schema, Habitats and Biotopes](http://inspire.ec.europa.eu/id/ats/data-hb/3.0/hb-as) | INSPIRE spatial data set |
| [Reference Systems, Habitats and Biotopes](http://inspire.ec.europa.eu/id/ats/data-hb/3.0/hb-rs) | INSPIRE spatial data set |
| [Data Consistency, Habitats and Biotopes](http://inspire.ec.europa.eu/id/ats/data-hb/3.0/hb-dc) | INSPIRE spatial data set |
| [Information Accessibility, Habitats and Biotopes](http://inspire.ec.europa.eu/id/ats/data-hb/3.0/hb-ia) | INSPIRE spatial data set |
| [Portrayal, Habitats and Biotopes](http://inspire.ec.europa.eu/id/ats/data-hb/3.0/hb-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Habitats and Biotopes - Core", are not needed as no feature instance can be of a type from that application schema.
