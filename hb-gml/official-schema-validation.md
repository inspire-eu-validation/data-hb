...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/hb/4.0/HabitatsAndBiotopes.xsd, using strict XML schema validation.
