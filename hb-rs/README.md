...
| ------------- | ----------------- | ---------------- | ---------- |
| [TG DS-HB](#ref_TG_DS_HB) | [GML application schema, Habitats and Biotopes](../hb-gml/README.md) | INSPIRE spatial data set encoded in GML, Habitats and Biotopes features | n/a |
